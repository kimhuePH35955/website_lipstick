    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{route('table.add')}}" class="btn btn-success">
                        Thêm mới
                    </a>
                </div>
                            ...
                            <table class="table table-bordered text-center mt-2" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Sô lượng sản phẩm</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($sanpham->categories->isNotEmpty())
                                            @foreach($sanpham->categories as $category)
                                            <p class="btn btn-info">{{ $category->name }}</p>
                                            @endforeach
                                            @else
                                            Không có danh mục
                                            @endif
                                        </td>
                                        <td><img src="{{ $sanpham->image?''.Storage::url($sanpham->image):''}}" width="80px" alt=""></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('table.edit',$sanpham->id)}}">Cập nhật</a>
                                                    @if($sanpham->quantity==0)
                                                    <a class="dropdown-item show_confirm" href="{{route('table.destroy',$sanpham->id)}}">Xoá</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
